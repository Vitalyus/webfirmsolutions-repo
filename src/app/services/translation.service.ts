...
export class TranslationService {
  ...
  private getFallbackText(keyPath: string): string {
    const fallbackMap: Record<string, string> = {
      ...
      'services.professional-web-design-agency.title': 'Frontend Development',
      'services.professional-web-design-agency.description': 'Modern, responsive interfaces built with Angular, React, or Vue.js. Specializing in component-based architecture, state management, performance optimization, and progressive web apps.',
      'services.advanced-frontend-development.title': 'Backend Development',
      'services.advanced-frontend-development.description': 'Robust server-side solutions with Node.js, Express, NestJS, and RESTful/GraphQL APIs. Expert in database design, authentication, caching strategies, and microservices architecture.',
      'services.technical-consulting-seo.title': 'Full-Stack Solutions & SEO',
      'services.technical-consulting-seo.description': 'Complete end-to-end web applications from concept to production deployment. Specialized in technical SEO, Core Web Vitals optimization, and cloud deployment.',
      ...
      'portfolio.links.interestedInWorking': 'Interested in working together? Learn more',
      'portfolio.links.aboutOurProcess': 'about our development process',
      'portfolio.links.orExplore': 'or explore our',
      'portfolio.links.fullRangeServices': 'full range of services',
      'portfolio.links.readyToStart': 'Ready to start your project?',
      'portfolio.links.getInTouchToday': 'Get in touch with us today',
      'portfolio.links.freeConsultation': 'for a free consultation',
      'services.links.exploreProjects': 'Explore our',
      'services.links.recentFrontendProjects': 'recent frontend projects',
      'services.links.learnAbout': 'or learn about our',
      'services.links.technologyStack': 'technology stack',
      'services.links.seeOur': 'See our',
      'services.links.backendSolutions': 'backend solutions',
      'services.links.orCheck': 'or check',
      'services.links.ourExperience': 'our experience',
      'services.links.inScalableArchitectures': 'in scalable architectures',
      'services.links.readMore': 'Read more',
      'services.links.aboutOurApproach': 'about our approach',
      'services.links.or': 'or',
      'services.links.getInTouch': 'get in touch',
      'services.links.forConsultation': 'for a consultation',
      'about.links.checkOut': 'Check out our',
      'about.links.fullStackServices': 'full-stack development services',
      'about.links.orView': 'or view our',
      'about.links.completedProjects': 'completed projects'
    };
